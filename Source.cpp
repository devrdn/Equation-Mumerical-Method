...
int main()
{
    ...
    double sup_1 = 2.367; // Супремум первой производной функции f на отрезке [a,b].
    double inf_1 = 1.748; // Инфимум  первой производной функции f на отрезке [a,b].
    double sup_2 = 1.632; // Супремум второй производной функции f на отрезке [a,b].
    double sup_g = 0.267; // Супремум первой производной функции g на отрезке [a,b].
